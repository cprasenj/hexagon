...
public class Employee {
	...
	public Employee(String[] employeeData) throws ParseException {
		this.firstName = employeeData[1];
		this.lastName = employeeData[0];
		this.birthDate = new XDate(employeeData[2]);
		this.email = employeeData[3];
	}
	...
	public String toString() {
		return "EmployeeRepository " + firstName + " " + lastName + " <" + email + "> born " + birthDate;
	}
